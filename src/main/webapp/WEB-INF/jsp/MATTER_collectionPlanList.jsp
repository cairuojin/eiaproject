        ...
        <tbody>
            <c:forEach items="${projectListVo.projectInfos}" var="projectInfo">
                <tr class="odd gradeX">
                    ...
                    <td class="center">
                        <a href="/api/admin/matter/collectionPlanInput?projectInfoId=${projectInfo.id}" >制定收款计划</a>&nbsp;&nbsp;
                    </td>
                </tr>
            </c:forEach>
        </tbody>
