...
<form id="documentRequirementForm">
    <table class="form">
        ...
        <tr>
            ...
            <td class="col2 tdcss2" style="padding-left: 30px;">
                <textarea cols="100" rows="100" style="width:95%;height: 80px;" id="requirements" name="requirements"></textarea>
            </td>
        </tr>
        <tr>
            <td class="col1 tdcss1">
            ...
            <td class="col2 tdcss2" style="padding-left: 30px;">
                <textarea cols="100" rows="100" style="width:95%;height: 80px;" id="archivelist" name="archivelist"></textarea>
            </td>
        </tr>
        <tr>
            <td class="col1 tdcss1" >
            ...
            <td class="col2 tdcss2" style="padding-left: 30px;" >
                <input type="number"  id="archivenumber" name="archivenumber"/>
            </td>
        </tr>
    </table>
</form>
<div class="btnnew" >
    <input type="submit" class="btn btn-primary" value="确定"  onclick="addDocumentRequirement()"/>&nbsp;&nbsp;
    ...
    function addDocumentRequirement() {
        if ($("#documentRequirementForm").valid()){
            if($('#requirements').val() == "" || $.trim($('#requirements').val()).length == 0){
                ...
                $.ajax({
                    "type":"POST",
                    "url":"/api/admin/system/addRequirement",	//传输路径
                    "data":data,
