                ...
                <tr>
                    ...
                    <td class="col2 tdcss2" style="padding-left: 30px;">
                        <c:if test="${user.sex == 0}">
                            <input type="radio" name="sex"  value="1" style="font-size: 14px;" required/>男
                            <input type="radio" name="sex"  value="2" style="font-size: 14px;" />女
                        </c:if>
                        <c:if test="${user.sex == 1}">
                            <input type="radio" name="sex"  value="1" style="font-size: 14px;" checked="checked" required/>男
                            <input type="radio" name="sex"  value="2" style="font-size: 14px;" />女
                        </c:if>
                        <c:if test="${user.sex == 2}">
                            <input type="radio" name="sex" value="1" style="font-size: 14px;" />男
                            <input type="radio" name="sex"  value="2" style="font-size: 14px;" checked="checked" required/>女
                        </c:if>
                    </td>
                </tr>
                <tr>
