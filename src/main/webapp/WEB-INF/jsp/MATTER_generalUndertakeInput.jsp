...
<div class="risktable4"  >
    <div class="risk_div bg_risk" style="width:15%;   ">部门经理意见</div>
    <div class="risk_div " style="width:85%; text-align: left; ">
        <div class="td_risk textcss " style="height: 78px;" >
            <textarea style="width: 100%; height: 48px;" disabled="disabled">${projectDepartmentUndertake.undertakingopinions}</textarea>
            签字：${projectDepartmentUndertake.user.name}&nbsp;&nbsp;签字时间：<fmt:formatDate value="${projectDepartmentUndertake.createtime}" pattern="yyyy年MM月dd日HH点mm分ss秒" />
        </div>
    </div>
</div>
