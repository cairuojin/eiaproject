...
--
-- Host: localhost    Database: eiaproject
-- ------------------------------------------------------
...
--
-- Table structure for table `approvalagreelqualifications`
--

DROP TABLE IF EXISTS `approvalagreelqualifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `approvalagreelqualifications` (
  `id` int(11) NOT NULL,
  `approvalUserId` int(11) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `qualificationNumber` int(11) DEFAULT NULL,
  `qualificationRemarks` text,
  `qualificationSerialNumber` varchar(500) DEFAULT NULL,
  `qualificationSerialUserId` int(11) DEFAULT NULL,
  `qualificationSerialTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='报批资质申请  id=projectId projectStatus = 27';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `approvalagreelqualifications`
--

LOCK TABLES `approvalagreelqualifications` WRITE;
/*!40000 ALTER TABLE `approvalagreelqualifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `approvalagreelqualifications` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `approvalannexopinion`
--

DROP TABLE IF EXISTS `approvalannexopinion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `approvalannexopinion` (
  `id` int(11) NOT NULL,
  `mettingSummaryAnnex` varchar(100) DEFAULT NULL COMMENT '会议总结',
  `mettingUserId` int(11) DEFAULT NULL,
  `mettingTime` datetime DEFAULT NULL COMMENT '会议总结时间',
  `approvalReportAnnex` varchar(100) DEFAULT NULL COMMENT '报批版报告',
  `approvalExpertOpinionsAnnex` varchar(100) DEFAULT NULL COMMENT '专家意见修改清单',
  `approvalUserId` int(11) DEFAULT NULL COMMENT '报批人',
  `approvalTime` datetime DEFAULT NULL COMMENT '报批时间',
  `implementStatus` int(11) DEFAULT NULL COMMENT '落实情况 0落实 1未落实',
  `implementRemarks` text COMMENT '未落实原因',
  `implementUserId` int(11) DEFAULT NULL,
  `implementTime` datetime DEFAULT NULL COMMENT '落实时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='报审资质申请  id=projectId projectStatus = 24/25/26';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `approvalannexopinion`
--

LOCK TABLES `approvalannexopinion` WRITE;
/*!40000 ALTER TABLE `approvalannexopinion` DISABLE KEYS */;
/*!40000 ALTER TABLE `approvalannexopinion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `approvalreply`
--

DROP TABLE IF EXISTS `approvalreply`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `approvalreply` (
  `id` int(11) NOT NULL,
  `createUserId` int(11) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `replyNumber` varchar(500) DEFAULT NULL COMMENT '批准文号',
  `replyTime` datetime DEFAULT NULL COMMENT '批复时间',
  `replyMessageAnnex` varchar(100) DEFAULT NULL COMMENT '批复信息附件',
  `remarks` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='批复信息  id=projectId projectStatus = 28';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `approvalreply`
--

LOCK TABLES `approvalreply` WRITE;
/*!40000 ALTER TABLE `approvalreply` DISABLE KEYS */;
/*!40000 ALTER TABLE `approvalreply` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `approvaltrialqualifications`
--

DROP TABLE IF EXISTS `approvaltrialqualifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `approvaltrialqualifications` (
  `id` int(11) NOT NULL,
  `approvalUserId` int(11) DEFAULT NULL COMMENT '申请人ID',
  `createTime` datetime DEFAULT NULL,
  `qualificationNumber` int(11) DEFAULT NULL COMMENT '资质份数',
  `qualificationRemarks` text COMMENT '申请说明',
  `qualificationSerialNumber` varchar(500) DEFAULT NULL COMMENT '资质流水号',
  `qualificationSerialUserId` int(11) DEFAULT NULL,
  `qualificationSerialTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='报审资质申请  id=projectId projectStatus = 23';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `approvaltrialqualifications`
--

LOCK TABLES `approvaltrialqualifications` WRITE;
/*!40000 ALTER TABLE `approvaltrialqualifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `approvaltrialqualifications` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) DEFAULT NULL COMMENT '父级ID   =0时为顶级',
  `name` varchar(45) DEFAULT NULL COMMENT '名称',
  `status` int(11) DEFAULT NULL COMMENT '状态 0正常   1 删除',
  `sort_order` int(11) DEFAULT NULL COMMENT '排序序号，同级之间越大排越前',
  `is_parent` int(11) DEFAULT NULL COMMENT '目录表树中位于第几层  0-横向   1竖父级 2竖子级',
  `role` varchar(300) DEFAULT NULL COMMENT '可见角色，以、隔开',
  `engname` varchar(80) DEFAULT NULL COMMENT '英语名，便于iframe',
  `createTime` datetime DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='目录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `category` VALUES (1,0,'待办事项',0,1,0,'ALL','MATTER','2019-01-23 10:15:00','2019-01-23 10:15:00'),(2,0,'项目管理',0,2,0,'ALL','PROJECT','2019-01-23 10:15:00','2019-01-23 10:15:00'),(3,0,'系统管理',0,3,0,'Administrators、Archivist','SYSTEM','2019-01-23 10:15:00','2019-01-23 10:15:00'),(4,0,'个人设置',0,4,0,'ALL','USER','2019-01-23 10:15:00','2019-01-23 10:15:00'),(5,1,'项目承接',0,1,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(6,1,'合同信息',0,2,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(7,1,'收款管理',0,3,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(8,1,'项目执行',0,4,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(9,1,'初审',0,5,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(10,1,'定稿审核',0,6,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(11,1,'报审报批',0,7,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(12,1,'项目资质',0,8,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(13,1,'存档管理',0,9,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(14,5,'人员分配',0,1,2,'DivisionManager、Administrators','allotmentList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(15,5,'踏勘信息录入',0,2,2,'EIAManager、Administrators','reconnaissanceList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(16,5,'风险分析录入',0,3,2,'EIAManager、Administrators','riskAnalysisList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(17,5,'部门承接判定',0,4,2,'DivisionManager、Administrators','departmentUndertakeList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(18,5,'总工办承接判定',0,5,2,'GeneralPublicOffice、Administrators','generalUndertakeList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(19,5,'总经理承接判定',0,6,2,'GeneralManager、Administrators','managerUndertakeList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(20,6,'合同信息录入',0,1,2,'EIAManager、DivisionManager、MarketPersonnel、Administrators','contractEntryList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(21,6,'合同信息领导签字',0,2,2,'DivisionManager、GeneralManager、Administrators','contractLeaderList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(22,6,'合同财务签字',0,3,2,'FinancialStaff、Administrators','contractFinanceList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(23,6,'合同盖章签字',0,4,2,'GeneralManager、ContractAdministrator、Administrators','contractSignatureList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(24,7,'收款计划',0,1,2,'FinancialStaff、EIAManager、DivisionManager、MarketPersonnel、Administrators','collectionPlanList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(25,7,'收款管理',0,2,2,'FinancialStaff、EIAManager、DivisionManager、MarketPersonnel、Administrators','collectionManageList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(26,8,'制定工作计划',0,1,2,'EIAManager、Administrators','workPlanMakeList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(27,8,'待落实工作计划',0,2,2,'EIAManager、Administrators','workPlanImplement','2019-01-23 10:15:00','2019-01-23 10:15:00'),(28,8,'监测方案提交',0,3,2,'EIAManager、Administrators','monitoringProgrammeList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(29,8,'提交初版报告',0,4,2,'EIAManager、Administrators','initialReportsList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(30,9,'初审',0,1,2,'EIAManager、Administrators、DivisionManager、GeneralPublicOffice、GeneralManager','firstTrialList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(31,9,'初审修改情况',0,2,2,'EIAManager、Administrators','firstTrialEditList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(32,9,'初审修改情况落实',0,3,2,'EIAManager、Administrators、DivisionManager、GeneralPublicOffice、GeneralManager','firstTrialImplementList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(33,10,'定稿审核',0,1,2,'EIAManager、Administrators、DivisionManager、GeneralPublicOffice、GeneralManager','finalTrialList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(34,10,'定稿审核修改情况',0,2,2,'EIAManager、Administrators','finalTrialEditList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(35,10,'定稿审核修改情况落实',0,3,2,'EIAManager、Administrators、DivisionManager、GeneralPublicOffice、GeneralManager','finalTrialImplementList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(36,11,'报审资质申请',0,1,2,'EIAManager、Administrators','approvalTrialQualificationsList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(37,11,'会议总结',0,2,2,'EIAManager、Administrators','approvalMettingList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(38,11,'提交报批/最终版报告',0,3,2,'EIAManager、Administrators','approvalReportList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(39,11,'评审会意见落实情况',0,4,2,'DivisionManager、GeneralPublicOffice、Administrators','approvalOpinionList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(40,11,'报批资质申请',0,5,2,'EIAManager、Administrators','approvalAgreelQualificationsList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(41,11,'录入批复信息',0,6,2,'EIAManager、Administrators','approvalReplyList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(42,12,'出资质',0,1,2,'AssetAdministrator、Administrators','projectQualificationsList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(43,13,'申请存档',0,1,2,'EIAManager、Administrators','documentApplicationList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(44,13,'存档清单领导签字',0,2,2,'DivisionManager、GeneralManager、Administrators','documentLeaderSignList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(45,13,'存档',0,3,2,'Archivist、Administrators','documentEnterList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(46,2,'项目管理',0,1,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(47,2,'项目统计',1,2,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(48,2,'我的项目',0,3,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(49,2,'档案查询',0,4,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(50,46,'项目信息',0,1,2,'ALL','projectInfo','2019-01-23 10:15:00','2019-01-23 10:15:00'),(51,46,'工作进度',0,2,2,'EIAManager、Administrators、MarketPersonnel、DivisionManager、GeneralPublicOffice、GeneralManager','processOfWorkList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(52,46,'资质补办',0,3,2,'EIAManager、Administrators','qualificationsReissueList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(53,47,'本部门项目统计',1,1,2,'DivisionManager、GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(54,47,'组织人按文件类型统计',1,2,2,'DivisionManager、GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(55,47,'承接人按文件类型统计',1,3,2,'DivisionManager、GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(56,47,'初审人按文件类型统计',1,4,2,'DivisionManager、GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(57,47,'定稿审核人按文件类型统计',1,5,2,'DivisionManager、GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(58,47,'部门项目统计',1,6,2,'GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(59,47,'项目状态统计',1,7,2,'GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(60,47,'项目区域分布——按部门',1,8,2,'GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(61,47,'项目区域分布——按文件类型',1,9,2,'GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(62,47,'项目区域分布-按审批级别',1,10,2,'GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(63,47,'环评师环评业绩统计',1,11,2,'GeneralPublicOffice、GeneralManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(64,48,'我承接的项目',0,1,2,'MarketPersonnel、EIAManager、DivisionManager、Administrators','myUndertakeProjectList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(65,48,'我主持的项目',0,2,2,'EIAManager、DivisionManager、Administrators','myHostProjectList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(66,48,'我初审的项目',0,3,2,'EIAManager、DivisionManager、GeneralManager、GeneralPublicOffice、Administrators','myFirstTrialProjectList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(67,48,'我定审的项目',0,4,2,'DivisionManager、GeneralManager、GeneralPublicOffice、Administrators','myFinalTrialProjectList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(68,48,'我暂存的项目',1,5,2,'EIAManager、Administrators',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(69,49,'存档查询',0,1,2,'Archivist、MarketPersonnel、EIAManager、DivisionManager、GeneralManager、GeneralPublicOffice、Administrators','documentQueryList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(70,3,'用户信息',0,1,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(71,3,'基础数据处理',0,2,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(72,70,'用户信息',0,1,2,'Administrators','userList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(73,70,'部门信息',0,2,2,'Administrators','department','2019-01-23 10:15:00','2019-01-23 10:15:00'),(74,71,'环评师管理',1,1,2,'Administrators、Archivist',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(75,71,'存档要求清单',0,2,2,'Administrators、Archivist','documentRequirementsList','2019-01-23 10:15:00','2019-01-23 10:15:00'),(76,4,'个人设置',0,1,1,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(77,76,'个人信息',0,1,2,'ALL','personalInfo','2019-01-23 10:15:00','2019-01-23 10:15:00'),(78,76,'个人信息设置',1,2,2,'ALL',NULL,'2019-01-23 10:15:00','2019-01-23 10:15:00'),(79,76,'密码设置',0,3,2,'ALL','changepassword','2019-01-23 10:15:00','2019-01-23 10:15:00');
...
--
-- Table structure for table `collectionplan`
--

DROP TABLE IF EXISTS `collectionplan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `collectionplan` (
  `id` int(11) NOT NULL,
  `collectionUserId` int(11) DEFAULT NULL COMMENT '收款人',
  `collectionTime` datetime DEFAULT NULL COMMENT '收款日期',
  `collectionMoney` double DEFAULT NULL COMMENT '收款金额',
  `collectionBePaidMoney` double DEFAULT NULL COMMENT '待收款金额',
  `remarks` text COMMENT '备注',
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='收款计划  id为projectId  projectStatus = 11';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `collectionplan`
--

LOCK TABLES `collectionplan` WRITE;
/*!40000 ALTER TABLE `collectionplan` DISABLE KEYS */;
/*!40000 ALTER TABLE `collectionplan` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `collectionrecord`
--
...
CREATE TABLE `collectionrecord` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projectId` int(11) DEFAULT NULL COMMENT '记录所对应的项目id',
  `recordUserId` int(11) DEFAULT NULL COMMENT '收款人',
  `recordTime` datetime DEFAULT NULL COMMENT '收款时间',
  `collectionMoney` double DEFAULT NULL COMMENT '此记录收款金额',
  `remarks` text,
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='收款记录  projectStatus = 12';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `collectionrecord`
--

LOCK TABLES `collectionrecord` WRITE;
/*!40000 ALTER TABLE `collectionrecord` DISABLE KEYS */;
/*!40000 ALTER TABLE `collectionrecord` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contractfinance`
--

DROP TABLE IF EXISTS `contractfinance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contractfinance` (
  `id` int(11) NOT NULL,
  `financeUserId` int(11) DEFAULT NULL COMMENT '财务用户id',
  `financeOpinions` text COMMENT '财务审核意见',
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='合同财务签字   projectstatus= 9  财务必须提交才会记录到此表 领导点击退回不记录到此表，操作记录表将有记录退回记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `contractfinance`
--

LOCK TABLES `contractfinance` WRITE;
/*!40000 ALTER TABLE `contractfinance` DISABLE KEYS */;
/*!40000 ALTER TABLE `contractfinance` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contractleader`
--

DROP TABLE IF EXISTS `contractleader`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contractleader` (
  `id` int(11) NOT NULL COMMENT '为项目id一一对应',
  `leaderUserId` int(11) DEFAULT NULL COMMENT '领导人ID',
  `leaderOpinions` text COMMENT '领导审核意见',
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='合同领导签字   projectstatus= 8  领导必须提交才会记录到此表 领导点击退回不记录到此表，操作记录表将有记录退回记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `contractleader`
--

LOCK TABLES `contractleader` WRITE;
/*!40000 ALTER TABLE `contractleader` DISABLE KEYS */;
/*!40000 ALTER TABLE `contractleader` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contractmessage`
--

DROP TABLE IF EXISTS `contractmessage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contractmessage` (
  `id` int(11) NOT NULL,
  `entryUserId` int(11) DEFAULT NULL COMMENT '合同信息录入人id',
  `contractnumber` varchar(100) DEFAULT NULL COMMENT '合同编号',
  `contractsigntime` datetime DEFAULT NULL COMMENT '合同签订日期',
  `contractamount` int(11) DEFAULT NULL COMMENT '合同份数',
  `contractannexURL` varchar(100) DEFAULT NULL COMMENT '合同附件地址',
  `contractmoney` double DEFAULT NULL COMMENT '合同款',
  `contractsummary` text COMMENT '合同摘要',
  `createTime` datetime DEFAULT NULL COMMENT '录入时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='合同信息表  id为projectId\n此时projectStatus=7';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `contractmessage`
--

LOCK TABLES `contractmessage` WRITE;
/*!40000 ALTER TABLE `contractmessage` DISABLE KEYS */;
/*!40000 ALTER TABLE `contractmessage` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `department` (
  ...
  `status` int(11) DEFAULT NULL COMMENT '状态 0正常   1 删除',
  `sort_order` int(11) DEFAULT NULL COMMENT '排序序号，同级之间越大排越前',
  `is_parent` int(11) DEFAULT NULL COMMENT '目录表树中位于第几层  0-顶层   1父层 2子层 3孙层',
  `type` int(11) DEFAULT NULL COMMENT '类型  0公司 1部门',
  `sort_num` varchar(100) DEFAULT NULL COMMENT '顺序号',
...
INSERT INTO `department` VALUES (1,-1,'河北清宁',0,1,0,1,'12312','124','124','124','124','124','河北清宁'),(2,1,'第一事业部',0,1,1,0,'123','125','125','125','125','125','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(3,1,'第二事业部',0,2,1,1,'123','126','126','126','126','126','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(4,1,'第三事业部',0,3,1,0,'123','127','127','127','127','127','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(5,1,'第四事业部',0,4,1,1,'123','128','128','128','128','128','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(6,1,'第五事业部',0,5,1,1,'123','129','129','129','129','129','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(7,2,'财务室',0,1,2,0,'123','130','130','130','130','130','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(8,2,'人事部',0,2,2,0,'123','131','131','131','131','131','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(9,3,'财务室',0,1,2,0,'123','132','132','132','132','132','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(10,3,'管理室',0,2,2,0,'123','133','133','133','133','133','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(11,4,'财务室',0,1,2,0,'123','134','134','134','134','134','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(12,4,'人事部',0,2,2,0,'','135','135','135','135','135','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(13,5,'财务室',0,1,2,0,'123','136','136','136','136','136','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(14,5,'档案室',0,2,2,0,'123','137','137','137','137','137','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(15,6,'财务室',0,1,2,0,'123','138','138','138','138','138','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(16,6,'总工办',0,2,2,0,'123','139','139','139','139','139','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(17,1,'江西分公司',0,6,1,1,'123','140','140','140','140','140','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(18,17,'总工办',0,1,2,0,'123','141','141','141','141','141','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(19,6,'档案室',0,3,2,0,'123','142','142','142','142','142','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123'),(20,17,'财务室',0,2,2,0,'123','143','143','143','143','143','123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123');
/*!40000 ALTER TABLE `department` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `documentapplication`
--

DROP TABLE IF EXISTS `documentapplication`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `documentapplication` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projectId` int(11) DEFAULT NULL COMMENT '项目id',
  `documentId` int(11) DEFAULT NULL COMMENT '存档id  对应projectinfofiletyedocument表的id',
  `archiveList` text,
  `archiveNumber` int(11) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `createUserId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目申请存档  projectStatus = 30';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `documentapplication`
--

LOCK TABLES `documentapplication` WRITE;
/*!40000 ALTER TABLE `documentapplication` DISABLE KEYS */;
/*!40000 ALTER TABLE `documentapplication` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `documentrepertoire`
--

DROP TABLE IF EXISTS `documentrepertoire`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `documentrepertoire` (
  `id` int(11) NOT NULL,
  `applicantUserId` int(11) DEFAULT NULL COMMENT '申请存档人',
  `applicantTime` datetime DEFAULT NULL COMMENT '申请时间',
  `keyword` varchar(100) DEFAULT NULL COMMENT '关键字',
  `summary` text COMMENT '摘要',
  `archiveDescription` text COMMENT '存档描述',
  `finalReportAnnex` varchar(100) DEFAULT NULL COMMENT '最终版报告',
  `leaderUserId` int(11) DEFAULT NULL COMMENT '领导id',
  `leaderTime` datetime DEFAULT NULL,
  `leadershipOpinion` varchar(100) DEFAULT NULL COMMENT '领导意见',
  `documentUserId` int(11) DEFAULT NULL COMMENT '存档人（档案管理员）',
  `documentTime` datetime DEFAULT NULL COMMENT '存档时间',
  `fileNumber` varchar(100) DEFAULT NULL COMMENT '档案编号',
  `fileLocation` varchar(100) DEFAULT NULL COMMENT '档案存放位置',
  `archivistOpinion` varchar(100) DEFAULT NULL COMMENT '档案管理员意见',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存单清单内容 id = projectId ， projectStatus = 30/31/32';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `documentrepertoire`
--

LOCK TABLES `documentrepertoire` WRITE;
/*!40000 ALTER TABLE `documentrepertoire` DISABLE KEYS */;
/*!40000 ALTER TABLE `documentrepertoire` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `finaltrialopinion`
--

DROP TABLE IF EXISTS `finaltrialopinion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `finaltrialopinion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projectId` int(11) DEFAULT NULL COMMENT '项目id',
  `finalOpinion` text COMMENT '复审意见',
  `createTime` datetime DEFAULT NULL COMMENT '创建复审时间',
  `updateOpinion` text COMMENT '修改内容',
  `updateTime` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='复审意见   projectStatus = 20/21/22';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `finaltrialopinion`
--

LOCK TABLES `finaltrialopinion` WRITE;
/*!40000 ALTER TABLE `finaltrialopinion` DISABLE KEYS */;
/*!40000 ALTER TABLE `finaltrialopinion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `finaltrialreport`
--

DROP TABLE IF EXISTS `finaltrialreport`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `finaltrialreport` (
  `id` int(11) NOT NULL,
  `createTime` datetime DEFAULT NULL COMMENT '复审用户',
  `finalOpinionAnnex` varchar(100) DEFAULT NULL COMMENT '定稿审核意见附件 ',
  `finalAnnotationreport` varchar(100) DEFAULT NULL COMMENT '定稿批注版报告',
  `approvalOpinionAnnex` varchar(100) DEFAULT NULL COMMENT '报审版报告',
  `status` int(11) DEFAULT NULL COMMENT '落实情况 0已落实   1未落实',
  `remarks` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='复审报告    id=projectId projectStatus = 20/21/22';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `finaltrialreport`
--

LOCK TABLES `finaltrialreport` WRITE;
/*!40000 ALTER TABLE `finaltrialreport` DISABLE KEYS */;
/*!40000 ALTER TABLE `finaltrialreport` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `firsttrialopinion`
--

DROP TABLE IF EXISTS `firsttrialopinion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `firsttrialopinion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projectId` int(11) DEFAULT NULL COMMENT '项目id',
  `firstOpinion` text COMMENT '初审意见',
  `createTime` datetime DEFAULT NULL COMMENT '创建初审时间',
  `updateOpinion` text COMMENT '修改内容',
  `updateTime` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='初审意见   projectStatus = 17/18/19';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `firsttrialopinion`
--

LOCK TABLES `firsttrialopinion` WRITE;
/*!40000 ALTER TABLE `firsttrialopinion` DISABLE KEYS */;
/*!40000 ALTER TABLE `firsttrialopinion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `firsttrialreport`
--

DROP TABLE IF EXISTS `firsttrialreport`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `firsttrialreport` (
  `id` int(11) NOT NULL,
  `createTime` datetime DEFAULT NULL COMMENT '初审用户',
  `firstOpinionAnnex` varchar(100) DEFAULT NULL COMMENT '初审意见附件',
  `firstAnnotationreport` varchar(100) DEFAULT NULL COMMENT '初审批注版报告',
  `finalOpinionAnnex` varchar(100) DEFAULT NULL COMMENT '定稿审核报告',
  `finalTrialUserId` int(11) DEFAULT NULL COMMENT '定稿审核人',
  `status` int(11) DEFAULT NULL COMMENT '落实情况 0已落实   1未落实',
  `remarks` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='初审报告    id=projectId projectStatus = 17/18/19';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `firsttrialreport`
--

LOCK TABLES `firsttrialreport` WRITE;
/*!40000 ALTER TABLE `firsttrialreport` DISABLE KEYS */;
/*!40000 ALTER TABLE `firsttrialreport` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectdepartmentundertake`
--

DROP TABLE IF EXISTS `projectdepartmentundertake`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectdepartmentundertake` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '为项目id一一对应',
  `undertakingUserId` int(11) DEFAULT NULL COMMENT '部门承接人员id',
  `undertakingOpinions` text COMMENT '承接意见',
  `undertakingSituation` int(11) DEFAULT NULL COMMENT '承接情况  1承接   3上报  2不承接，不存记录到此表  operationrecord表有记录',
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目部门承接';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectdepartmentundertake`
--

LOCK TABLES `projectdepartmentundertake` WRITE;
/*!40000 ALTER TABLE `projectdepartmentundertake` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectdepartmentundertake` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectgeneralundertake`
--

DROP TABLE IF EXISTS `projectgeneralundertake`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectgeneralundertake` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '为项目id一一对应',
  `undertakingUserId` int(11) DEFAULT NULL COMMENT '总工办承接人员id',
  `undertakingOpinions` text COMMENT '承接意见',
  `undertakingSituation` int(11) DEFAULT NULL COMMENT '承接情况  1承接   3上报    2不承接、不存记录到此表  operationrecord表有记录',
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目总工办承接   status= 5';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectgeneralundertake`
--

LOCK TABLES `projectgeneralundertake` WRITE;
/*!40000 ALTER TABLE `projectgeneralundertake` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectgeneralundertake` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `projectinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `number` varchar(100) DEFAULT NULL COMMENT '项目编号  时间戳+类型',
  `name` varchar(100) DEFAULT NULL COMMENT '项目名称',
  `builder` varchar(200) DEFAULT NULL COMMENT '建设方',
  `province` varchar(20) DEFAULT NULL,
  `city` varchar(20) DEFAULT NULL,
  `area` varchar(20) DEFAULT NULL,
  `filingDepartment` varchar(100) DEFAULT NULL COMMENT '备案部门',
  `constructionSite` varchar(45) DEFAULT NULL COMMENT '建设地点',
  `fileType` int(11) DEFAULT NULL COMMENT '文件类型，关联文件类型表',
  `evaluationScope` int(11) DEFAULT NULL COMMENT '评价范围类别',
  `contacts` varchar(100) DEFAULT NULL COMMENT '项目联系人',
  `builderContact` varchar(100) DEFAULT NULL COMMENT '建设方联系电话',
  `subordinateDepartmentId` int(11) DEFAULT NULL COMMENT '所属部门Id',
  `projectUndertakerUserId` int(11) DEFAULT NULL COMMENT '项目承接人用户Id 关联用户表',
  `contractMoney` varchar(45) DEFAULT NULL COMMENT '预估合同款  万元',
  `remarks` text COMMENT '备注',
  `status` int(11) DEFAULT NULL COMMENT '项目状态  0新建',
  `createUserId` int(11) DEFAULT NULL COMMENT '创建人  关联用户表  创建时的当前用户',
  `organizingUserId` int(11) DEFAULT NULL COMMENT '组织人  关联用户表  分配人员',
  `hostUserId` int(11) DEFAULT NULL COMMENT '主持人  关联用户表  分配人员',
  `undertakeTime` datetime DEFAULT NULL COMMENT '承接时间',
  `initialReportUserId` int(11) DEFAULT NULL COMMENT '项目执行中，提交报告人',
  `firstTrialUserId` int(11) DEFAULT NULL COMMENT '初审人Id',
  `finalTrialUserId` int(11) DEFAULT NULL COMMENT '复审人id',
  `createTime` datetime DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目信息主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `projectinfofiletype`
--

DROP TABLE IF EXISTS `projectinfofiletype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectinfofiletype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `filetypeCombine` int(11) DEFAULT NULL COMMENT '多对多连接Key    ',
  `shortName` varchar(10) DEFAULT NULL COMMENT '标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='项目文件类型';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectinfofiletype`
--

LOCK TABLES `projectinfofiletype` WRITE;
/*!40000 ALTER TABLE `projectinfofiletype` DISABLE KEYS */;
INSERT INTO `projectinfofiletype` VALUES (1,'建设项目环境影响报告书',1,'bb'),(2,'现状评估报告',1,'nr'),(3,'建设项目安全预评价',1,'be'),(4,'建设项目环境影响报告表',2,'bc'),(5,'建设项目环境影响报告表—专项',2,'bs'),(6,'变更补充报告',2,'cr'),(7,'规划类环境影响报告书',3,'pb'),(8,'地下水评价',3,'ge'),(9,'排污许可技术报告',3,'dr'),(10,'应急预案',3,'cp'),(11,'验收报告',3,'ar');
/*!40000 ALTER TABLE `projectinfofiletype` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectinfofiletypedocument`
--

DROP TABLE IF EXISTS `projectinfofiletypedocument`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectinfofiletypedocument` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `filetypeId` int(11) DEFAULT NULL COMMENT '文件类型ID',
  `requirements` text COMMENT '存档要求',
  `archiveList` text COMMENT '项目存档清单',
  `archiveNumber` int(11) DEFAULT NULL COMMENT '存档份数',
  `createUserId` int(11) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='文件类型-存档要求清单';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectinfofiletypedocument`
--

LOCK TABLES `projectinfofiletypedocument` WRITE;
/*!40000 ALTER TABLE `projectinfofiletypedocument` DISABLE KEYS */;
INSERT INTO `projectinfofiletypedocument` VALUES (7,1,'编写管理表原件','编写管理表原件',1,1,'2019-02-25 14:30:33'),(8,1,'评估意见（原件或复印件）','评估意见原件',1,1,'2019-02-25 14:30:44'),(9,1,'专家意见、签字表（原件或复印件）','专家意见、签字表原件',1,1,'2019-02-25 14:30:53'),(10,1,'环评执行标准批复（原件或复印件）','环评执行标准批复原件',1,1,'2019-02-25 14:31:03'),(11,1,'环境监测报告原件','环境监测报告原件',1,1,'2019-02-25 14:31:25'),(12,1,'委托书原件','委托书原件',2,1,'2019-02-25 14:31:32'),(13,1,'建设单位公众参与承诺函（原件），第一、二次公示内容（建设单位盖章），公众参与调查表，其他公众参与专家反馈意见的原始资料，公众参与专题报告，听证会相关资料。 或建设单位报送的公参单行本1本','建设单位公众参与承诺函（原件），第一、二次公示内容（建设单位盖章），公众参与调查表，其他公众参与专家反馈意见的原始资料，公众参与专题报告，听证会相关资料。 或建设单位报送的公参单行本1本',1,1,'2019-02-25 14:31:47'),(14,1,'1份送审稿','1份送审稿',1,1,'2019-02-25 14:31:56'),(15,1,'3份编写人员亲笔签名的报批版','3份编写人员亲笔签名的报批版',3,1,'2019-02-25 14:32:15'),(16,1,'电子件（包含：各级审核电子版，送审版电子版，报批版电子版，所有附件扫描件电子版及编制过程中所有涉及的电子文件。如可研报告电子件，收集到的其他相关资料电子版，现场踏勘照片，公众参与照片，审查会照片等）','各级审核电子版，送审版电子版，报批版电子版，所有附件扫描件电子版及编制过程中所有涉及的电子文件。如可研报告电子件，收集到的其他相关资料电子版，现场踏勘照片，公众参与照片，审查会照片等',1,1,'2019-02-25 14:32:25'),(17,1,'原始预测文件(含大气、风险、地下水、噪声(二级)、地表水(二维模式)评价等级估算文件)','大气、风险、地下水、噪声(二级)、地表水(二维模式)评价等级估算文件(电子版)',1,1,'2019-02-25 14:36:44'),(18,1,'股份合计存档要求存档要求存档要求','项目存档清单项目存档清单项目存档清单项目存档清单项目存档清单项目存档清单项目存档清单项目存档清单',1334,1,'2019-02-25 22:49:36');
/*!40000 ALTER TABLE `projectinfofiletypedocument` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectinfoscope`
--

DROP TABLE IF EXISTS `projectinfoscope`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectinfoscope` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `filetypeCombine` int(11) DEFAULT NULL COMMENT '多对多连接Key    ',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='评价范围类别';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectinfoscope`
--

LOCK TABLES `projectinfoscope` WRITE;
/*!40000 ALTER TABLE `projectinfoscope` DISABLE KEYS */;
INSERT INTO `projectinfoscope` VALUES (1,'轻工纺织化纤',1),(2,'化工石化医药',1),(3,'冶金机电',1),(4,'建材火电',1),(5,'农林水利',1),(6,'采掘',1),(7,'交通运输',1),(8,'社会服务',1),(9,'海洋工程',1),(10,'输变电及广电通讯',1),(11,'核工业',1),(12,'一般项目环境影响报告表',2),(13,'核与辐射项目环境影响报告表',2),(14,'无',3);
/*!40000 ALTER TABLE `projectinfoscope` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectinfostatus`
--

DROP TABLE IF EXISTS `projectinfostatus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectinfostatus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='项目状态表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectinfostatus`
--

LOCK TABLES `projectinfostatus` WRITE;
/*!40000 ALTER TABLE `projectinfostatus` DISABLE KEYS */;
INSERT INTO `projectinfostatus` VALUES (1,'待分配人员'),(2,'待录入踏勘信息'),(3,'待录入风险分析'),(4,'待部门承接判定'),(5,'待总工办承接判定'),(6,'待总经理承接判定'),(7,'待录入合同信息'),(8,'合同信息领导签字'),(9,'待合同信息财务签字'),(10,'待合同盖章签字'),(11,'待制定收款计划'),(12,'待进行项目收款管理'),(13,'待执行工作计划'),(14,'待完成工作计划'),(15,'待提交监测方案'),(16,'待提交初版报告'),(17,'待初审'),(18,'待初审后修改'),(19,'待落实初审'),(20,'待定稿审核'),(21,'待定稿审核后修改'),(22,'待落实定稿'),(23,'待申请报审资质'),(24,'待进行会议总结'),(25,'待提交报批/最终版报告'),(26,'待录入评审会意见'),(27,'待申请报批资质'),(28,'待录入批复信息'),(29,'待出资质'),(30,'待申请存档'),(31,'待领导签字存档清单'),(32,'待存档'),(33,'已存档');
/*!40000 ALTER TABLE `projectinfostatus` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectinitialreport`
--

DROP TABLE IF EXISTS `projectinitialreport`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectinitialreport` (
  `id` int(11) NOT NULL,
  `initialreportUserId` int(11) DEFAULT NULL COMMENT '生成报告人员id',
  `createTime` datetime DEFAULT NULL,
  `firstTrialReportAnnex` varchar(100) DEFAULT NULL COMMENT '初版报告地址',
  `firstTrialUserId` int(11) DEFAULT NULL COMMENT '指定的初审人员',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目执行 初版报告  id为projectId  status=16';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectinitialreport`
--

LOCK TABLES `projectinitialreport` WRITE;
/*!40000 ALTER TABLE `projectinitialreport` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectinitialreport` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectmanagerundertake`
--

DROP TABLE IF EXISTS `projectmanagerundertake`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectmanagerundertake` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '为项目id一一对应',
  `undertakingUserId` int(11) DEFAULT NULL COMMENT '总经理承接人员id',
  `undertakingOpinions` text COMMENT '承接意见',
  `undertakingSituation` int(11) DEFAULT NULL COMMENT '承接情况  1承接   3上报    2不承接、不存记录到此表  operationrecord表有记录',
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目总经理承接 status=6';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectmanagerundertake`
--

LOCK TABLES `projectmanagerundertake` WRITE;
/*!40000 ALTER TABLE `projectmanagerundertake` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectmanagerundertake` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectmonitoringprogramme`
--

DROP TABLE IF EXISTS `projectmonitoringprogramme`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectmonitoringprogramme` (
  `id` int(11) NOT NULL COMMENT ' id为projectId',
  `monitoringUserId` int(11) DEFAULT NULL COMMENT '监控人id',
  `createTime` datetime DEFAULT NULL,
  `designatedPerson` varchar(100) DEFAULT NULL COMMENT '指定的人员',
  `monitoringprogramme` text COMMENT '监控方案',
  `annux` varchar(100) DEFAULT NULL COMMENT '附件',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目监控方案  id为projectId  status=15';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectmonitoringprogramme`
--

LOCK TABLES `projectmonitoringprogramme` WRITE;
/*!40000 ALTER TABLE `projectmonitoringprogramme` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectmonitoringprogramme` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectoperationrecord`
--

DROP TABLE IF EXISTS `projectoperationrecord`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectoperationrecord` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `time` datetime DEFAULT NULL COMMENT '操作时间',
  `userId` int(11) DEFAULT NULL COMMENT '操作人id',
  `projectInfoId` int(11) DEFAULT NULL COMMENT '操作项目id',
  `projectInfoStatus` int(11) DEFAULT NULL COMMENT '操作项目的状态（哪个阶段）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目操作记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectoperationrecord`
--

LOCK TABLES `projectoperationrecord` WRITE;
/*!40000 ALTER TABLE `projectoperationrecord` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectoperationrecord` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectqualification`
--

DROP TABLE IF EXISTS `projectqualification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectqualification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projectId` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL COMMENT '0报审版  1报批版',
  `qualificationNumber` varchar(100) DEFAULT NULL COMMENT '资质流水号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='出资质   status0 报审版  status1 报批版';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectqualification`
--

LOCK TABLES `projectqualification` WRITE;
/*!40000 ALTER TABLE `projectqualification` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectqualification` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectreconnaissance`
--

DROP TABLE IF EXISTS `projectreconnaissance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectreconnaissance` (
  `id` int(11) NOT NULL,
  `reconnaissanceUserId` int(11) DEFAULT NULL COMMENT '踏勘人员id',
  `informationList` text COMMENT '收集资料清单',
  `siteConditions` text COMMENT '现场踏勘情况',
  `existingProblems` text COMMENT '踏勘存在问题',
  `annex` varchar(100) DEFAULT NULL COMMENT '踏勘附件地址',
  `mapLng` varchar(45) DEFAULT NULL COMMENT '踏勘位置经度',
  `mapLat` varchar(45) DEFAULT NULL COMMENT '踏勘位置纬度',
  `filePic1` varchar(100) DEFAULT NULL COMMENT '图片地址',
  `filePic2` varchar(100) DEFAULT NULL,
  `filePic3` varchar(100) DEFAULT NULL,
  `filePic4` varchar(100) DEFAULT NULL,
  `filePic5` varchar(100) DEFAULT NULL,
  `filePicName1` varchar(45) DEFAULT NULL,
  `filePicName2` varchar(45) DEFAULT NULL,
  `filePicName3` varchar(45) DEFAULT NULL,
  `filePicName4` varchar(45) DEFAULT NULL,
  `filePicName5` varchar(45) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目踏勘表  id为projectId\n此时projectStatus=2';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectreconnaissance`
--

LOCK TABLES `projectreconnaissance` WRITE;
/*!40000 ALTER TABLE `projectreconnaissance` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectreconnaissance` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectriskanalysis`
--

DROP TABLE IF EXISTS `projectriskanalysis`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectriskanalysis` (
  `id` int(11) NOT NULL COMMENT '为项目id一一对应',
  `riskanalysisUserId` int(11) DEFAULT NULL COMMENT '风险分析录入人员id',
  `eiacategory` int(11) DEFAULT NULL COMMENT '环评类别 1报告书  2报告表',
  `companyQualification` int(11) DEFAULT NULL COMMENT '公司资质范围是否含盖 1是 2否',
  `projectInformation` varchar(500) DEFAULT NULL COMMENT '项目所属行业',
  `projectInvestment` varchar(500) DEFAULT NULL COMMENT '工程投资',
  `natureconstruction` int(11) DEFAULT NULL COMMENT '项目建设性质 1新建 2技改 3扩建 4搬迁 5现状评估',
  `contentsofconstruction` text COMMENT '建设内容',
  `processroute` text COMMENT '主要工艺路线',
  `constructionscale` varchar(500) DEFAULT NULL COMMENT '建设规模',
  `geographicalposition` varchar(500) DEFAULT NULL COMMENT '地理位置',
  `projectcategory` int(11) DEFAULT NULL COMMENT '立项类别 1审批制 2备案制 3核准制',
  `projectgrade` int(11) DEFAULT NULL COMMENT '立项等级  1 国家级   2省级  3 市级   4县级',
  `extension` varchar(500) DEFAULT NULL COMMENT '改扩建企业是否存在问题\n 1企业限批   2未批先建   3限期治理   4落后淘汰   5其他   6不涉',
  `drainage` int(11) DEFAULT NULL COMMENT '有无排水去向 1 有   2无   3不排水',
  `environmental` int(11) DEFAULT NULL COMMENT '有无环境容量 1有   2无   3不确定',
  `contaminants` int(11) DEFAULT NULL COMMENT '有无污染物排放总量 1有   2无   3不确定',
  `entrycriteria` int(11) DEFAULT NULL COMMENT '行业准入条件符合1符合   2不符合   3无准入条件',
  `otherpolicies` int(11) DEFAULT NULL COMMENT '其他相关产业政策、环保政策 1符合   2不符合   3无要求',
  `twohighandonecapital` int(11) DEFAULT NULL COMMENT ' 有两高一资项目 1是 2否',
  `industry` int(11) DEFAULT NULL COMMENT '所在区域地方产业政策 1 符合  2 不符合   3无要求',
  `environmentalprotection` int(11) DEFAULT NULL COMMENT '所在区域地方环保政策 1 符合  2 不符合   3无要求',
  `hygiene` int(11) DEFAULT NULL COMMENT '卫生防护距离要求 1满足   2不满足   3无要求',
  `park` int(11) DEFAULT NULL COMMENT '园区产业定位、布局要求 1满足   2不满足   3无要求',
  `otherlocation` int(11) DEFAULT NULL COMMENT '其他选址规定要求 1满足   2不满足   3无要求',
  `involvingprotectedareas` varchar(500) DEFAULT NULL COMMENT '涉及保护区 \n 1南水北调    \n2地下水源保护区   \n3地表水源保护区    \n4自然保护区    \n5风景名胜区    \n6文物古迹    \n7基本农田保护区    \n8水土流失区    \n9其他保护区    \n10不涉及',
  `othersensitivetargets` varchar(500) DEFAULT NULL COMMENT '其它敏感目标 \n1、军事设施   \n2、机场    \n3、敏感企业(如食品厂)     \n4、电力及通讯设施   \n5、铁路、交通干道    \n6、河道、泛洪区     \n7、其他    \n8、不涉',
  `otherquestions` text COMMENT '其他问题',
  `projectgroupcomments` text COMMENT '项目组意见',
  ...
  `Remarks5` varchar(500) DEFAULT NULL,
  `Remarks6` varchar(500) DEFAULT NULL,
  `Remarks7` varchar(500) DEFAULT NULL,
  `Remarks8` varchar(500) DEFAULT NULL,
  `Remarks9` varchar(500) DEFAULT NULL,
  `Remarks10` varchar(500) DEFAULT NULL,
  `Remarks11` varchar(500) DEFAULT NULL,
  `Remarks12` varchar(500) DEFAULT NULL,
  `Remarks13` varchar(500) DEFAULT NULL,
  `Remarks14` varchar(500) DEFAULT NULL,
  `Remarks15` varchar(500) DEFAULT NULL,
  `Remarks16` varchar(500) DEFAULT NULL,
  `Remarks17` varchar(500) DEFAULT NULL,
  `Remarks18` varchar(500) DEFAULT NULL,
  `Remarks19` varchar(500) DEFAULT NULL,
  `Remarks20` varchar(500) DEFAULT NULL,
  `Remarks21` varchar(500) DEFAULT NULL,
  `Remarks22` varchar(500) DEFAULT NULL,
  `Remarks23` varchar(500) DEFAULT NULL,
  `Remarks24` varchar(500) DEFAULT NULL,
  `Remarks25` varchar(500) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目风险分析  id为projectId  projectStatus = 3';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectriskanalysis`
--

LOCK TABLES `projectriskanalysis` WRITE;
/*!40000 ALTER TABLE `projectriskanalysis` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectriskanalysis` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projectworkplan`
--

DROP TABLE IF EXISTS `projectworkplan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `projectworkplan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projectId` int(11) DEFAULT NULL COMMENT '项目id',
  `status` int(11) DEFAULT NULL COMMENT '工作计划状态 0制定未落实 1已落实',
  `makePlanUserId` int(11) DEFAULT NULL COMMENT '制定计划用户id',
  `workPlanTime` datetime DEFAULT NULL COMMENT '工作日期',
  `workPlanContent` varchar(100) DEFAULT NULL COMMENT '工作内容',
  `partyBperson` varchar(45) DEFAULT NULL COMMENT '乙方责任人',
  `responsibleParty` varchar(45) DEFAULT NULL COMMENT '责任方',
  `remarks` varchar(100) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL COMMENT '创建时间 制定计划时间',
  `implementsPlanUserId` int(11) DEFAULT NULL COMMENT '落实计划用户id',
  `implementsPlanTime` datetime DEFAULT NULL COMMENT '执行日期',
  `implementsRemarks` varchar(100) DEFAULT NULL COMMENT '执行备注',
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间  落实计划时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目工作计划  projectStatus = 13/14';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projectworkplan`
--

LOCK TABLES `projectworkplan` WRITE;
/*!40000 ALTER TABLE `projectworkplan` DISABLE KEYS */;
/*!40000 ALTER TABLE `projectworkplan` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `role` (
  ...
  `engName` varchar(45) DEFAULT NULL COMMENT '角色名 英语',
  `createTime` datetime DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `role` VALUES (0,'管理员','Administrators',NULL,NULL),(1,'总经理','GeneralManager',NULL,NULL),(2,'总公办','GeneralPublicOffice',NULL,NULL),(3,'部门经理','DivisionManager',NULL,NULL),(4,'环评经理','EIAManager',NULL,NULL),(5,'合同管理员','ContractAdministrator',NULL,NULL),(6,'市场人员','MarketPersonnel',NULL,NULL),(7,'档案管理员','Archivist',NULL,NULL),(8,'资产管理员','AssetAdministrator',NULL,NULL),(9,'财务人员','FinancialStaff',NULL,NULL);
...
CREATE TABLE `user` (
  ...
  `department` int(11) DEFAULT NULL COMMENT '部门，外键，连接部门表',
  `role` int(11) DEFAULT NULL COMMENT '角色，外键，连接角色表',
  `hiredate` date DEFAULT NULL COMMENT '入职时间',
  `contactway` varchar(45) DEFAULT NULL COMMENT '联系方式',
  `weChat` varchar(45) DEFAULT NULL COMMENT '微信',
  `email` varchar(45) DEFAULT NULL COMMENT '邮箱',
  `officelocation` varchar(200) DEFAULT NULL COMMENT '办公地点',
...
INSERT INTO `user` VALUES (1,'cairuojin','123123','蔡若锦',2,1,0,'9999-12-03','2222222','1111111111','137711786@qq.com','广济寺123','images/personalImg/1550324056099_t.cn.certificate.jpg',0,'2019-01-30 00:00:00','2019-02-17 10:36:30'),(2,'Administrators','123456','管理员',1,1,0,'2014-01-29','2222222','1111111111','2222222','123','',0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(3,'GeneralManager','123456','总经理',0,1,1,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(4,'GeneralPublicOffice','123456','总公办',0,1,2,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(5,'DivisionManager','123456','部门经理',0,1,3,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(6,'EIAManager','123456','环评经理',0,1,4,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(7,'ContractAdministrator','123456','合同管理员',0,1,5,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(8,'MarketPersonnel','123456','市场人员',0,2,6,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(9,'Archivist','123456','档案管理员',0,3,7,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(10,'AssetAdministrator','123456','资产管理员',1,10,8,'2014-01-29','2222222','1111111111','2222222','',NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(11,'FinancialStaff','123456','财务人员',0,5,9,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(12,'ABC0','123456','王小丫',0,1,0,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(14,'ABC222','123456','周云福',0,2,0,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(15,'ABC3','123456','周亚夫',0,3,3,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(16,'ABC4','123456','张一凡',0,4,4,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(17,'ABC5','123456','王小帅',0,5,5,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(18,'ABC6','123456','陈小武',0,6,6,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(19,'ABC7','123456','陈国富',0,7,7,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(20,'ABC8','123456','陈泽',0,8,8,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(21,'ABC9','123456','陈伟奋',0,9,9,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(22,'ABC10','123456','辰塔维',0,10,0,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(24,'ABC123','123456','蔡仁杰',0,1,2,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(25,'ABC13','123456','蔡梅',0,1,3,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(26,'ABC144','123456','黄鹤',0,2,4,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(27,'ABC15','123456','黄梦丹',0,3,5,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(28,'ABC16','123456','朱丹',0,4,6,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(29,'ABC17','123456','唐伟',0,5,7,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(30,'ABC18','123456','唐万成',0,6,8,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(31,'ABC19','123456','冯万户',0,7,9,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(32,'ABC20','123456','冯巩陈',0,8,0,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(34,'ABC22','123456','李堂堂',0,10,2,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(35,'ABC23','123456','李百万',0,11,3,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(36,'ABC24','123456','李梅丹',0,1,4,'2014-01-29','2222222','1111111111','2222222',NULL,NULL,0,'2019-01-30 00:00:00','2019-01-30 00:00:00'),(53,'huangxiaoxin','123123','你还敢上传图片',2,8,0,'2015-01-01','','','','','images/personalImg/15488355983646252.jpg',NULL,'2019-01-30 15:31:23','2019-01-30 15:31:23');
...
-- Dump completed on 2019-02-27 15:02:22
